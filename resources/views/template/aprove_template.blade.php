...
@endcomponent
    @component('mail::button', ['url' => route('index')])
        Ghé thăm BlinhStore tại đây
    @endcomponent
    <p>Tổng tiền: {{number_format($total) . ' VNĐ'}}</p>
    <p>Cảm ơn bạn đã tin tưởng mua hàng tại BlinhStore</p>
    <p>Chúc bạn luôn có những trải nghiệm tuyệt vời khi mua sách tại BlinhStore</p>
